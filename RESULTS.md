...
| **Exp 5** | `hidden=128`, `inter=256`, `layers=4` | 561.98 | 1407.50 | 10.66 | `transformer_cap2_best.keras` | Better, beats baseline, still worse than the first config: h64, context 48: sMAPE 10.1148; h128, context 48: sMAPE 10.6660 |